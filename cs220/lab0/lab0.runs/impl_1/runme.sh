...
HD_PWD='D:/Locker/PANEPISTIMIO/lab0/lab0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lab0_tb.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lab0_tb.tcl -notrace
