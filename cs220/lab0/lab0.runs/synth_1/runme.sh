...
HD_PWD='D:/Locker/PANEPISTIMIO/lab0/lab0.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lab0_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lab0_tb.tcl
