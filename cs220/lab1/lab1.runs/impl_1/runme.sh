...
HD_PWD='D:/Locker/PANEPISTIMIO/lab1/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_maze_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source vga_maze_top.tcl -notrace
