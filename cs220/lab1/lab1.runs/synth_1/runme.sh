...
HD_PWD='D:/Locker/PANEPISTIMIO/lab1/lab1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log vga_maze_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source vga_maze_top.tcl
