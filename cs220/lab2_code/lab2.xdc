...
# Filename: lab2.xdc
# Description: Xilinx Design Constraint file for Lab 2 
#
################################################################################
...
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN F22 [get_ports {i_dip[0]}];  # "SW0"
set_property PACKAGE_PIN G22 [get_ports {i_dip[1]}];  # "SW1"
set_property PACKAGE_PIN H22 [get_ports {i_dip[2]}];  # "SW2"
set_property PACKAGE_PIN F21 [get_ports {i_dip[3]}];  # "SW3"
set_property PACKAGE_PIN H19 [get_ports {i_dip[4]}];  # "SW4"
set_property PACKAGE_PIN H18 [get_ports {i_dip[5]}];  # "SW5"
set_property PACKAGE_PIN H17 [get_ports {i_dip[6]}];  # "SW6"
set_property PACKAGE_PIN M15 [get_ports {i_dip[7]}];  # "SW7"
