...
int main(){
	...
	pthread_create(&tid_2, NULL, create_indegree, NULL);
	pthread_join(tid_2, NULL);

        pthread_create(&tid_3, NULL, create_outdegree, NULL);
        pthread_join(tid_3, NULL);

        pthread_create(&tid_4, NULL, create_degree, NULL);
