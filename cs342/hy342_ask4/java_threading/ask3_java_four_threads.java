 ...
 * @author Manos
 */
public class ask3_java_four_threads extends Thread {
    ...
    public static void main(String[] args){
        Thread t1 = new ask3_java_four_threads();
        Thread t2 = new ask3_java_four_threads();
        Thread t3 = new ask3_java_four_threads();
        Thread t4 = new ask3_java_four_threads();
